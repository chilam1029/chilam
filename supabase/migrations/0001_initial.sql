...
begin
 ...
 insert into public.mochis(user_id,month_key,genetics) values(v_user,v_month,jsonb_build_object('seed',encode(gen_random_bytes(8),'hex'))) on conflict do nothing;
